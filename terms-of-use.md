...
- Attempt to extract the plant catalog data, image assets, or AI prompts for use outside the App
...
Sprout is free to download and includes a free tier with limited features. Pro features (unlimited plant tracking, AI diagnosis, full encyclopedia) require an active Sprout Pro subscription.

### 3.2 Pricing

| Plan | Price |
|---|---|
| Sprout Pro — Monthly | HK$38.00 per month |
| Sprout Pro — Annual | HK$228.00 per year (save ~50%) |

Prices are listed in Hong Kong Dollars (HKD). The App Store will display the equivalent price in your local currency at the applicable exchange rate. Prices may vary by region.

### 3.3 Free Trial

A **7-day free trial** is available for new subscribers. If you do not cancel before the trial ends, your payment method will be charged the applicable subscription price and the subscription will begin.

### 3.4 Automatic Renewal

Subscriptions **automatically renew** at the end of each billing period (monthly or annual) unless cancelled at least 24 hours before the renewal date. Your Apple ID account will be charged within 24 hours before the end of the current period. We may change subscription prices; where required by applicable law, we will notify you in advance and obtain your consent.

### 3.5 Cancellation

You may cancel your subscription at any time through **iOS Settings → [Your Name] → Subscriptions → Sprout**. Cancellation takes effect at the end of the current billing period; you retain Pro access until that date. We do not provide partial refunds for unused portions of a billing period.

### 3.6 Refunds

All purchases are processed by Apple and are subject to **Apple's refund policy**. To request a refund, visit [reportaproblem.apple.com](https://reportaproblem.apple.com). We do not process refunds directly.

### 3.7 Restore Purchases

If you reinstall the App or switch devices, tap "Restore Purchases" in the App settings to recover your Pro access using the same Apple ID.
...
By using the AI diagnosis feature, you consent to transmitting selected photos to our AI processing partner (Google Vertex AI) for the purpose of plant health analysis. See our Privacy Policy for details.

You retain all ownership rights to Your Content. You are responsible for ensuring that any photos you submit do not infringe third-party intellectual property rights.
...
Feng shui placement suggestions are provided for entertainment and cultural reference purposes and do not constitute professional feng shui consultation.
...
- Attempt to gain unauthorised access to our systems or third-party services used by the App
...
OUR TOTAL AGGREGATE LIABILITY ARISING OUT OF OR IN CONNECTION WITH THESE TERMS OR THE APP SHALL NOT EXCEED THE AMOUNT YOU PAID FOR THE APP IN THE 12 MONTHS PRECEDING THE CLAIM.

Nothing in these Terms limits or excludes any liability that cannot be limited or excluded under applicable law (including the Consumer Protection provisions applicable in Hong Kong, the UK, Australia, Canada, and other jurisdictions).
...
**UK residents:** Your statutory rights under UK consumer law are not affected by these Terms. You may also resolve disputes through the applicable UK alternative dispute resolution scheme.

**EU residents:** You may submit a complaint to the ODR platform at [ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr).
